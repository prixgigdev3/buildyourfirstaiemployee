      ...
      <div className="mx-auto flex min-h-14 w-full max-w-7xl items-center justify-between gap-2 px-4 sm:min-h-16 sm:gap-6 sm:px-8">
        ...
        <div className="flex shrink-0 items-center gap-0.5 sm:gap-2">
          ...
          <a
            href={CHECKOUT_URL}
            className={cn(
              "inline-flex min-h-11 min-w-11 shrink-0 cursor-pointer touch-manipulation items-center justify-center rounded-full bg-join px-4 text-sm font-extrabold text-on-join sm:px-5",
              "transition-[transform,background-color,opacity] duration-150 ease-out",
              "hover:bg-accent-hover active:scale-[0.96] active:opacity-90",
